...
void main() {
    LicenseRegistry.addLicense(() async* {
        final licenseGFont = await rootBundle.loadString(
    ...
    Widget build(BuildContext context) {
        return Scaffold(
            ...
            body: LayoutBuilder(builder: (context, boxConstraints) {
                double calcDegree = (atan(
                    (boxConstraints.maxHeight * 0.5 * 0.1) /
                ...
                return Stack(
                    children: <Widget>[
                                        ...
                                        onTap: () =>
                                            Navigator.of(context).push(
                                                MaterialPageRoute(builder: (
                                                    context) => Custom())),
                                        customBorder: MiddleShapePainter(
                                            0, calcDegree),
                                        child: Container(
                                            child: Padding(
                                                padding: EdgeInsets.all(8),
                        ...
                        Positioned(
                            top: boxConstraints.maxHeight * 0.85 -
                                distanceOffset * 2,
                            child: Container(
                                    ...
                                    child: InkWell(
                                        onTap: () =>
                                            Navigator.push(context,
                                                MaterialPageRoute(builder: (
                                                    context) => Settings())),
                                        customBorder: BottomShapePainter(
                                            0, calcDegree),
                                        child: Padding(
